...
argParser.add_argument("-i", "--input", type=str, help="input folder containing current logs", required=True)
argParser.add_argument("-m", "--min", type=int, help="minimum voltage to calculate from", default=0)
...
fitYs = [p[0] + p[1] * x for x in fitXs]
